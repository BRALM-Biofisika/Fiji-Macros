...
dir = getDirectory("Choose the Directory of the images to process");
...
dir0 = getDirectory("Choose the Directory of the images to save the tiles");
...
dir1 = getDirectory("Choose the Directory of the images to save the splitted z-stacks");
